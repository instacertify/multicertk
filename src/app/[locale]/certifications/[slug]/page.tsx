...
export default async function SchemePage({
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10">
      ...
      <h2 className="mt-10 font-display text-2xl text-navy">Markets</h2>
      ...
      {scheme.slug === "bee" ? (
        <>
          <h2 className="mt-10 font-display text-2xl text-navy">BEE labelled appliances</h2>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
      ...
      {scheme.slug === "g-mark" ? (
        <>
          <h2 className="mt-10 font-display text-2xl text-navy">G-Mark listed categories</h2>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
