  ...
  const faqs = [
    {
      ...
      a: `${product.qcoStatus === "mandatory" ? "Yes." : product.qcoStatus === "upcoming" ? "A QCO has been notified." : "It is currently voluntary / buyer-driven."} The governing standard is ${product.standard}.`,
    },
    {
